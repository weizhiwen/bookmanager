        ...
        <div class="main-right col-lg-10 col-md-10 col-sm-9">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <form action="${pageContext.request.contextPath}/user_changePassword.action?usId=${loginUser.usId}" method="post">
                        <div class="">
                            <div class="form-group input-group-sm">
                                <label for="id">借书证号：</label>
                                <input type="text"  id="id" class="form-control" value="${loginUser.usId}" disabled>
                            </div>&nbsp;
                            <div class="form-group input-group-sm">
