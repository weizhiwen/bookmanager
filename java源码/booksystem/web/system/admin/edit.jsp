        ...
        <div class="main-right col-lg-10 col-md-10 col-sm-9">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <form action="${pageContext.request.contextPath}/user_editAdmin.action" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-inline">
                            <div class="form-group input-group-sm">
                                <img src="${pageContext.request.contextPath}/user_showImg.action?usId=${user.usId}" alt="头像">
