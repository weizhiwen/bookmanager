        ...
        <div class="main-right col-lg-10 col-md-10 col-sm-9">
            <div class="row">
                <ul class="breadcrumb">
                    <span>当前位置：</span>
                    <li><a href="#">用户管理</a></li>
                    <li class="active">新增管理</li>
                </ul>
            </div>
            <div class="panel panel-default">
                <div class="panel-body">
                    <form action="$!{pageContext.request.contextPath}/user_addAdmin.action" method="post" enctype="multipart/form-data">
