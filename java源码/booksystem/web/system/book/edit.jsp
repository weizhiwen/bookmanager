                    ...
                    <form action="${pageContext.request.contextPath}/book_edit.action" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-inline">
                            <div class="form-group input-group-sm">
                                ...
                                <textarea name="bkBrief" id="brief" cols="60" rows="10">${book.bkBrief}</textarea>
                                <%--<input type="text" id="brief" class="form-control"  name="bkBrief">--%>
                            </div>
                        </div>
                        <div class="form-inline">
                            <div class="form-group input-group-sm">
                                <img src="${pageContext.request.contextPath}/book_showImg.action?bkId=${book.bkId}" alt="头像" width="80" height="100">
