        ...
        <div class="main-right col-lg-10 col-md-10 col-sm-9">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <form action="${pageContext.request.contextPath}/book_add.action" method="post" enctype="multipart/form-data">
                        <div class="form-inline">
                            <div class="form-group input-group-sm">
                                <label for="id">图书序号：</label>
                                <input type="number"  id="id" class="form-control" name="bkId">
                            </div>&nbsp;
                            <div class="form-group input-group-sm">
                                <label for="code">索书号：</label>
                                <input type="number"  id="code" class="form-control" name="bkCode">
                            </div>&nbsp;
                            <div class="form-group input-group-sm">
                                <label for="name">图书名称：</label>
                                <input type="text" id="name" class="form-control"  name="bkName">
                            </div>&nbsp;
                            <div class="form-group input-group-sm">
                                <label for="author">图书作者：</label>
                                <input type="text" id="author" class="form-control"  name="bkAuthor">
                            </div>
                        </div><br />
                        <div class="form-inline">
                            <div class="form-group input-group-sm">
                                <label for="press">出版社：</label>
                                <input type="text" id="press" class="form-control"  name="bkPress">
                            </div>
                            <div class="form-group input-group-sm">
                                <label for="datePress">出版日期：</label>
                                <input type="date" id="datePress" class="form-control"  name="bkDatePress">
                            </div>&nbsp;
                            <div class="form-group input-group-sm">
                                <label for="catalog">分类号：</label>
                                <input type="text" id="catalog" class="form-control" name="bkCatalog">
                            </div>
                            <div class="form-group input-group-sm">
                                <label for="isbn">ISBN：</label>
                                <input type="number" id="isbn" class="form-control"  name="bkIsbn">
                            </div>
                        </div><br />
                        <div class="form-inline">
                            <div class="form-group input-group-sm">
                            ...
                            <div class="form-group input-group-sm">
                                ...
                                <input type="number" id="page" class="form-control"  name="bkPages">
                            </div>&nbsp;
                            <div class="form-group input-group-sm">
                                <label for="price">图书价格：</label>
                                <input type="text" id="price" class="form-control" name="bkPrice">
                            </div>
                            <div class="form-group input-group-sm">
                                <label for="dateIn">入馆日期：</label>
                                <input type="date" id="dateIn" class="form-control" name="bkDateIn">
                            </div>
                        </div><br />
                        <div class="form-inline">
                            <div class="form-group input-group-sm">
                                <label for="brief">内容简介：</label><br>
                                <textarea name="bkBrief" id="brief" cols="60" rows="10"></textarea>
                                <%--<input type="text" id="brief" class="form-control"  name="bkBrief">--%>
                            </div>
                        </div>
                        <div class="form-inline">
                            <div class="form-group input-group-sm">
                                <label for="img">封面照片：</label>
